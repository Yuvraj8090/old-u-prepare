...
var savedConfig = localStorage.getItem("__CONFIG__"),
    ...
    changeThemeMode = function(e) {
        document.getElementsByTagName("html")[0].setAttribute("data-bs-theme", e), config.theme = e, saveState()
    },
    init = function() {
    ...
    initTheme = function() {
        ...
        e && e.addEventListener("click", function(e) {
            "light" === config.theme ? changeThemeMode("dark") : changeThemeMode("light")
        })
    };
