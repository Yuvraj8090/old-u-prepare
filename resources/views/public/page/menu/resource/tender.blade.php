                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <div>
                                                <span style="font-size: 13.3333px;">
                                                    <a href="#">
                                                        <span style="color: #ff0000; font-size: 14pt; font-weight: bold;">You're invited to Pre-Proposal Meeting for 
                                                        Discussion regarding tender published for Procurement Under different packages. </span>
                                                    </a>
                                                </span>
                                            </div>
                                            <div>
                                                <span style="font-size: 13.3333px;">Wednesday, 27 Aug 2025</span>
                                                <br>
                                                <span style="font-size: 13.3333px;">03:00 pm - 06:00pm (IST)</span>
                                            </div>
                                            <div>
                                                <span style="font-size: 13.3333px;">
                                                    <br>
                                            ...
                                            <div>
                                                <span style="font-size: 13.3333px;">
                                                    <span style="font-size: 12pt; font-style: italic; color: #0000ff; font-weight: bold;">• </span>
                                                    <a href="https://meet.google.com/cbz-bngu-hva" target="_blank">
                                                        <span style="font-size: 12pt; font-style: italic; color: #0000ff; font-weight: bold;">https://meet.google.com/cbz-bngu-hva</span>
                                                    </a>
                                                    <br>
                                                    <span>Tap on the link or paste it in a browser to join.</span>
                                                </span>
                                    ...
                                    <td>27<sup>th</sup> of Aug 2025</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
