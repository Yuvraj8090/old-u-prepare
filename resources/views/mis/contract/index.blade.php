...
@section('content')
    <div>
        <div class="row col-md-12" style="display: inline-block;padding-left:12px;">
            ...
            <h4>Contract's Form of Securities</h4>
    ...
    <div class="x_panel">
        <div class="row">
            <div class="col-md-12">
                <div class="x_title">
                    <a href="#" class="btn btn-primary btn-sm float-right" type="button" class="btn btn-primary" data-toggle="modal" data-target="#addSModal">Add Security</a>
                    <h2>Contract's Form of Securities</h2>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <span class="txt-aoe"></span> Security
                    </h5>
                ...
                <form autocomplete="off" data-method="POST" data-action="{{ route('contract.security.save') }}" class="form-horizontal form-label-left ajax-form dt" enctype="multipart/form-data">
    ...
    <script>
        ...
        $(function() {
            ...
            $gb_DataTable = $(".data-table").DataTable({
                ajax: "{{ route('contract.securities') }}",
                order: [0, "ASC"],
                paging: true,
                columns: [
            ...
            $('.data-table').on('click', '.btn-danger', function() {
                ...
                let occb = ()=> {
                    ...
                    let pm = {
                        url: '{{ route("contract.security.delete") }}',
                        data: fd
                    }
