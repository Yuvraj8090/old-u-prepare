        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_title d-flex align-items-center justify-content-between">
                    <h2>Contract's Type of Securities</h2>

                    <div>
                        <a href="#" class="btn btn-primary btn-sm" type="button" class="btn btn-primary" data-toggle="modal" data-target="#addSModal">Add Security</a>
                        <a href="{{ route('contract.security.type.forms') }}" class="btn btn-primary btn-sm">Manage Form of Securities</a>
                    </div>
    ...
    <script>
        ...
        $(function() {
            ...
            $gb_DataTable = $(".data-table").DataTable({
                ajax: "{{ route('contract.security.types') }}",
                order: [0, "ASC"],
                paging: true,
                columns: [
