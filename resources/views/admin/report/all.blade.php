...
@section('content')
    ...
    <div>
        <div class="row col-md-12" style="display: inline-block;padding-left:12px;">
            <h4> U-PREPARE | Project Summary Report - {{ $filters['department'] }}
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#"> Project Summary Report - {{ $filters['department'] }} </a></li>
                </ol>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <h3 class="pdf-heading text-center" style="text-decoration:underline;"> U-PREPARE | Project Summary Report - {{ $filters['department'] }}</h3>
            ...
            <table id="tableExportData" class="table table-striped table-bordered w-100">
                <thead>
                    <tr>
                        <th style="width: 1%">#</th>
                        ...
                        <th style="width:180px;">Procurement <br>Status (%)</th>
                        <th style="width:180px;">Contract <br>Status</th>
                        <th style="width:180px;">Physical <br> Status (%)</th>
                        <th style="width:180px;">Financial <br> Status (%)</th>
                        <th style="width:180px;">Financial Cost (₹)</th>
                    </tr>
                </thead>
                <tbody>
