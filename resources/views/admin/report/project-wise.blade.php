...
@section('content')
    ...
    <div>
        <div class="row col-md-12" style="display: inline-block;padding-left:12px;">
            ...
            <h4>  <b> U-PREPARE | Project Finance Report :- Project Wise </b>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#"> Project Finance Report :- Project Wise</a></li>
                </ol>
        ...
        <div class="x_panel">
            ...
            <div id="tableExportData" class="x_content">
                <h3 class="pdf-heading text-center" style="text-decoration:underline;">U-PREPARE | Project Finance Report - Project Wise</h3>
                ...
                <table id="datatable" class="table table-striped table-bordered w-100">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" colspan="2">Financial Details</th>
                        </tr>
                        <tr style="font-weight:700;" >
                            ...
                            <th>Financial Progress (%) & Value</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        @if(count($data) > 0)
                            @foreach($data as $key => $d)
                                ...
                                <th class="text-center" style="font-size:20px !important;">
                                ...
                                <td class="project_progress">
                                        ...
                                        <br><br>
                                        <b> Financial Value (INR)  :  {{ number_format($d->ProjectTotalfinancialAccumulativeCost ?? 0) }}</b>
                                </td>
                            </tr>
                            @endforeach
                        @else
