...
<div class="x_panel">
    <div class="x_title">
        ...
        <h2 style="font-weight:700;">MileStones </h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <br>
        <form autocomplete="off" data-method="POST" data-action="{{ route('mile.stone.store',$data->id) }}" class="form-horizontal form-label-left ajax-form">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9 col-sm-9 ">
                    <input type="number" class="form-control" name="percent_of_work" placeholder="Percentage of Work..">
