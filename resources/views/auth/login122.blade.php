        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form method="POST" action="{{ route('login') }}">
              ...
              <h1> <i class="fa fa-user"></i> Login Form</h1>
              <div>
              ...
              <div>
                ...
                <a class="reset_pass btn btn-danger" href="{{ route('password.request') }}" >Lost your password?</a>
              </div>
              ...
              <div class="separator">
                ...
                <div>
                  <!-- <h1><i class="fa fa-user"></i> U-Prepare <hr/> </h1> -->
                   <h5>   Department Of Disaster Management   </h5>
                  <p>© {{date('Y')}} All Rights Reserved.  Department Of Disaster Management! Govt Of Uttarakhand</p>
                </div>
              </div>
            </form>
          </section>
            ...
            <form>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-user"></i> U-Prepare <hr/> </h1>
                   <h5>   Department Of Disaster Management   </h5>
                  <p>©2016 All Rights Reserved.  Department Of Disaster Management! Govt Of Uttarakhand</p>
                </div>
              </div>
            </form>
          </section>
