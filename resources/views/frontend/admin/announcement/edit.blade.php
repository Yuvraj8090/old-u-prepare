        ...
        <div class="container-fluid">
            <div class="pb-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Edit Announcement</h4>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form data-action="{{route('announcement.update',$announcement->id)}}" data-method="PATCH"  class="needs-validation" id="ajax-form" novalidate>
                                        @csrf
                                        <div class="mb-3">
                                            <label for="simpleinput" class="form-label">Title (English)</label>
                                            <input type="text" id="simpleinput" class="form-control" name="eng_title" placeholder="Title (English)" value="{{old('eng_title',$announcement->eng_title)}}">
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea id="editor" class="" name="eng_content" required>{!! old('eng_content',$announcement->eng_content) !!}</textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label for="example-email" class="form-label">Title (Hindi)</label>
                                            <input type="text" id="example-title" name="hin_title" class="form-control" placeholder="Title (Hindi)" value="{{old('hin_title',$announcement->hin_title)}}">
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea id="editor" class="" name="hin_content" required>{!! old('hin_content',$announcement->hin_content) !!}</textarea>
                                        </div>
                                        <fieldset class="row mb-3">
                                            <legend class="col-form-label col-sm-2 pt-0">Show on View</legend>
                                            <div class="col-sm-10 d-flex gap-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="show" id="gridRadios1" value="1" @if($announcement->show ==1 ) checked @endif>
                                                    <label class="form-check-label" for="gridRadios1">Yes</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="show" id="gridRadios2" value="0" @if($announcement->show !=1 ) checked @endif>
                                                    <label class="form-check-label" for="gridRadios2">No</label>
                                                </div>
                                            </div>
                                        </fieldset>
                                        <div>
                                            <button class="btn btn-primary" type="submit">Edit Announcement</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
